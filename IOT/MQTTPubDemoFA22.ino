...
#define DHTpin 4   //Set DHT pin as GPIO2
DHTesp dht;
const int NUM_ROWS = 10;
const int NUM_COLS = 25;

// Make predictions using the classifier
float y_pred[NUM_ROWS]; 
/**** LED Settings *******/
const int led = 2; //Set LED pin as GPIO5
...
//const char* mqtt_server = "d8487ef1944d4e13aa8703a1d3c5c07f.s2.eu.hivemq.cloud";
                          
const char* mqtt_server = "67db6cf8147a425eba4d78f459be5e40.s2.eu.hivemq.cloud";
const char* mqtt_username = "iotclass";

const char* mqtt_password = "CPE445IoT";
...
// float temperature = dht.getTemperature();
  ...
  publishMessage("esp8266/temphum", mqtt_message, true);
